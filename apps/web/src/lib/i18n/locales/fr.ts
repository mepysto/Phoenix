...
export const fr: Translations = {
  ...
  map: {
    ...
    demo: "Mode démo — données d'exemple, pas des événements réels",
  ...
  cameras: {
    ...
    streamOffline: "Flux hors ligne ; affichage de la dernière image",
    liveDirect: "la vidéo en direct vient directement de l'exploitant de la caméra, qui voit votre adresse IP",
  },
  telemetry: {
    altitude: "Altitude",
    onGround: "Au sol",
  ...
  detail: {
    ...
    notFoundBody: "L'événement demandé est introuvable.",
  ...
  errors: {
    ...
    errorBody: "Une erreur inattendue s'est produite lors du chargement de cette page.",
    errorId: "ID d'erreur",
    retry: "Réessayer",
  },
};
