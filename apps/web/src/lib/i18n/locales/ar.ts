...
export const ar: Translations = {
  ...
  map: {
    ...
    demo: "وضع العرض التوضيحي — بيانات نموذجية وليست أحداثًا حقيقية",
    viewMode: "وضع العرض",
    viewModes: {
      normal: "عرض عادي",
      nvg: "رؤية ليلية",
  ...
  agent: {
    ...
    micError: "تعذر استخدام الميكروفون (الإذن أو دعم المتصفح).",
    suggestions: {
  ...
  detail: {
    ...
    notFoundBody: "تعذر العثور على الحدث المطلوب.",
    ...
    location: "الموقع",
    affectedPopulation: "السكان المتضررون",
    startDate: "تاريخ البدء",
    endDate: "تاريخ الانتهاء",
    lastUpdated: "آخر تحديث",
    actions: "إجراءات",
    affectedCount: "{n} متضرر",
  },
  errors: {
    ...
    errorBody: "حدث خطأ غير متوقع أثناء تحميل هذه الصفحة.",
    errorId: "معرّف الخطأ",
    retry: "إعادة المحاولة",
  },
};
