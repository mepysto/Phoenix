...
export const ru: Translations = {
  ...
  map: {
    ...
    demo: "Демо-режим — примерные данные, не реальные события",
  ...
  cameras: {
    ...
    liveVideo: "Видео в реальном времени",
    streamOffline: "Поток недоступен; показан последний снимок",
    liveDirect: "видео идёт напрямую от оператора камеры, который видит ваш IP-адрес",
  },
  telemetry: {
    altitude: "Высота",
    onGround: "На земле",
  ...
  detail: {
    ...
    notFoundBody: "Запрошенное событие не найдено.",
    back: "К списку событий",
    active: "Активно",
    ...
    location: "Местоположение",
    affectedPopulation: "Пострадавшее население",
    startDate: "Дата начала",
    endDate: "Дата окончания",
    lastUpdated: "Последнее обновление",
    actions: "Действия",
    affectedCount: "Пострадавших: {n}",
  },
  errors: {
    ...
    errorBody: "При загрузке страницы произошла непредвиденная ошибка.",
    errorId: "Код ошибки",
    retry: "Повторить",
  },
};
